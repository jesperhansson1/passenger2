...
public class DriveRequest implements Serializable {
    ...
    public DriveRequest(String passengerId, long time, Position startLocation, Position endLocation, int extraPassengers, double price, List<Object> driverIdBlacklist) {
